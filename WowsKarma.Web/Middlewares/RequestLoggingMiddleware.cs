	...
	public class RequestLoggingMiddleware
	{
		...
		public async Task Invoke(HttpContext context)
		{
			...
			try
			{
				...
				log.Write(level, MessageTemplate, context.Request.Method, GetPath(context), statusCode, elapsedMs);
			}
		...
		{
			LogForErrorContext(httpContext).Error(ex, MessageTemplate, httpContext.Request.Method, GetPath(httpContext), 500, elapsedMs);
